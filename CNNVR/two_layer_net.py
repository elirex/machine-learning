...
# The difference shoudl be very small. We get < 1e-7
...
# and analytic gradients should be less than 1e-8 for each of W1, W2, b1, and b2.

# These should all be less than 1e-8 or so
for param_name in grads:
    f = lambda W: net.loss(X, y, reg=0.1)[0]
    param_grad_num = eval_numerical_gradient(f, net.params[param_name], verbose=False)
    print('{0:s} max relative error: {1:e}'.format(param_name, rel_error(param_grad_num, grads[param_name])))
